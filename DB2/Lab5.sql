...
INSERT INTO TABLE2(TESTCOLUMN) VALUES(CURRENT_DATE);
INSERT INTO TABLE3(TESTCOLUMN, TABLE2_ID) VALUES (1, 2);
...
DECLARE
    ...
    RESTORE_DATE TIMESTAMP := TO_TIMESTAMP('2024-05-09 18:23:00', 'YYYY-MM-DD HH24:MI:SS');
BEGIN
...
--CREATE OR REPLACE DIRECTORY my_dir AS 'D:\labs';
...
--         UTL_FILE.fclose (file_id);
    ...
    DECLARE
        REPORT_DATE TIMESTAMP := TO_TIMESTAMP('2024-05-09 18:12:30', 'YYYY-MM-DD HH24:MI:SS');
    BEGIN
...
INSERT INTO TABLE1(TESTCOLUMN) VALUES ('TEST555');

DECLARE
    TABLES STRING_ARRAY := STRING_ARRAY('TABLE1');
    RESTORE_DATE TIMESTAMP := TO_TIMESTAMP('2024-05-11 09:00:00', 'YYYY-MM-DD HH24:MI:SS');
BEGIN
    RESTORE_DATA(TABLES, RESTORE_DATE);
END;