...
/*
DROP TABLE C##dev_schema.T2;
DROP TABLE C##dev_schema.T3;
DROP TABLE C##dev_schema.T1;
*/
...
CREATE TABLE C##dev_schema.T3(
    ...
    FOREIGN KEY (fkt2) REFERENCES C##dev_schema.T2(id)
);
...
CREATE TABLE C##dev_schema.T1(
    ...
    FOREIGN KEY (fkt3) REFERENCES C##dev_schema.T3(id)
);
